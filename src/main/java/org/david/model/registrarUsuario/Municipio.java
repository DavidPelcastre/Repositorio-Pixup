...
import org.david.model.sql.implementacion.MunicipioJdbcImpl;
...
public class Municipio extends Catalogo {
    ...
    public void setIdEstado(int id){
        this.estado = (Estado) buscarPorID(estados, id);
    }
    ...
    public void leerBaseDatos() {
        municipios = MunicipioJdbcImpl.getInstance().findAll();
    }

    public void guardarBaseDatos() {
        MunicipioJdbcImpl db = MunicipioJdbcImpl.getInstance();
        for (Municipio e : municipios) {
            db.guardar(e);
        }
    }
